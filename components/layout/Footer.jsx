...
import { ShoppingCart, Mail, Phone, MapPin, Github, Twitter, Instagram } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Your trusted online marketplace. Quality products, fast delivery, great prices.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { href: "/products?sort=price&order=asc", label: "Best Prices" },
              ].map((link) => (
                <li key={link.href}>
